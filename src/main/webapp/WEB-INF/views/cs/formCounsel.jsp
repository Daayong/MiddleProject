							...
							<c:if test="${tempPaymentID ne paymentList.payment_id}">
								<div class="order_prd">
									<div class="top">
										<div class="tit">
											<div class="rad_wrap">
												<input style="width: 100%; height: 128px;" type="radio" id="order_payment_id" name="order_payment_id" value="" data-pay_nm="${paymentList.payment_id}"  data-prd_nm="${paymentList.product_name}" >
									...
									<div class="prd_list_n">
										...
										<c:if test="${paymentList.payment_id eq paymentListA.payment_id}">
											<li>
												<div class="rad_wrap">
													<input style="width: 100%; height: 128px;" type="radio" id="order_payment_id1" name="order_payment_id1" value="" data-pay_num="${paymentListA.payment_id}"  data-prd_num="${paymentListA.product_name}"  >
